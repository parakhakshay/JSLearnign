...
console.log(`===================to select last there element in array  using length property==============`);
...
const arraySlicedLAstTHreeELement = arrayNumber.slice(arrayNumber.length-3);

console.log(arraySlicedLAstTHreeELement);
